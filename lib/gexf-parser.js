;(function(undefined) {
  ...
  function Graph(xml) {
    ...
    // change in _data function to get "attribute title" as key in the node.attribute object
    // GEXF Parser does not pass the proper keys for attributes #583
    function _data(model, node_or_edge) {
      ...
      model.map(function(a) {
        ...
        data[key] = !(key in ah) && 'defaultValue' in a ?
            ...
            _helpers.enforceType(a.type, ah[key]);
